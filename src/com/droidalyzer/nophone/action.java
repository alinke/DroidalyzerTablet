...
package com.droidalyzer.nophone;
...
//		drunkDialButton_.setOnClickListener(this); 
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.placesButton) {
			...
			.setClass(this,
					com.droidalyzer.nophone.Places.class);
		...
		if (v.getId() == R.id.TaxiMagicButton) {
			Intent intent = new Intent()
			.setClass(this,
					com.droidalyzer.nophone.getTaxi.class);
		...
		if (v.getId() == R.id.whereamiButton) {
			Intent intent = new Intent()
			.setClass(this,
					com.droidalyzer.nophone.whereami.class);
		...
		if (v.getId() == R.id.facebookPostButton) {
			...
			if (!Utility.mFacebook.isSessionValid()) {				 
				...
				Intent intent = new Intent()
				.setClass(this,
						com.droidalyzer.nophone.facebookPost.class);
		...
		if (v.getId() == R.id.tweetButton) {
			Intent intent = new Intent()
			.setClass(this,
					com.droidalyzer.nophone.tweetPost.class);
